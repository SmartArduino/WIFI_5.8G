...
/* 70. 2.4Ghz AP mode Channel Check */
    printf ("%$T============================\n");
    printf ("%$T## Test Case No.70 ##\n");
    
    printf ("%@Sat*ict*apstart=test24g 13\f");
    
    if (wait_string ("*ICT*AP_STARTED:OK", 5, buff) == 1)
    {
        printf ("%@CTest Case 70 : Pass\f");
        printf ("%$T============================\n");
    }
    else
    {
