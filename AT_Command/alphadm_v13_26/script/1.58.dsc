...
/* 58. 2.4Ghz AP mode Channel Check */
    printf ("%$T============================\n");
    printf ("%$T## Test Case No.58 ##\n");
    
    printf ("%@Sat*ict*apstart=test24g 1\f");
    
    if (wait_string ("*ICT*AP_STARTED:OK", 5, buff) == 1)
    {
        printf ("%@CTest Case 58 : Pass\f");
        printf ("%$T============================\n");
