...
/* 106. 5Ghz AP mode Security Check */
    printf ("%$T============================\n");
    printf ("%$T## Test Case No.106 ##\n");
    
    printf ("%@Sat*ict*apstart=testÅ×½ºÆ®$$_5 36 2 0 0 test12345678\f");
    
    if (wait_string ("*ICT*AP_STARTED:OK", 5, buff) == 1)
    {
        printf ("%@CTest Case 106 : Pass\f");
        printf ("%$T============================\n");
    }
    else
    {
