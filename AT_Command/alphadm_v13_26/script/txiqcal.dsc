...
#define REG_ADD1    0x90020054
#define REG_ADD2    0x90020056
#define REG_MUL1    0x90020058
#define REG_MUL2    0x9002005A
#define REG_MUL3    0x9002005C
...
void init_windows (void)
{
    ...
    SetWindowTitle ("TxIQ Calibration Test");
    
    SetLabel (TXT_SCALE, 390, 7, 400, STEP-2, "Step");
    
    y = 25;
    SetLabel (GAIN, 10, y, 120, STEP, "Tx Gain Mismatch");   y+= STEP;
    SetLabel (PHASE,10, y, 120, STEP, "Tx Phase Mismatch");  y+= STEP;
    ...
    y = 115;
    SetLabel (ADD1, 10, y, 50, STEP, "TxAdd1");    y+= STEP;
    SetLabel (ADD2, 10, y, 50, STEP, "TxAdd2");    y+= STEP;
    SetLabel (MUL1, 10, y, 50, STEP, "TxMult1");   y+= STEP;
    SetLabel (MUL2, 10, y, 50, STEP, "TxMult2");   y+= STEP;
    SetLabel (MUL3, 10, y, 50, STEP, "TxMult3");   y+= STEP;        
...
void read_register (int read_modem)
{
    ...
    printf ("%@Smem dump %x %d 16\f", REG_ADD1, 5*2);
    gets(buff); /* skip shell command  */
    gets(buff); /* skip blank line */    
    gets(buff);	
    
    add1 = strtoul (&buff[10], &end, 16);
    add2 = strtoul (end, &end, 16);
    mul1 = strtoul (end, &end, 16);
