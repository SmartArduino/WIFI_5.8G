...
/* 108. 5Ghz AP mode Security Check */
    printf ("%$T============================\n");
    printf ("%$T## Test Case No.108 ##\n");
    
    printf ("%@Sat*ict*apstart=testÅ×½ºÆ®$$_5 36 3 1 1 test12345678\f");
    
    if (wait_string ("*ICT*AP_STARTED:OK", 5, buff) == 1)
    {
        printf ("%@CTest Case 108 : Pass\f");
        printf ("%$T============================\n");
    }
    else
    {
